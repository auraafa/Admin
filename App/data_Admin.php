              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo $mhs['status_akun'];?></td>
                    <td><?php echo $mhs['level'];?></td>
                    <td>
                      <a href="delete/hapus_data.php?id_admin=<?php echo $mhs['id_admin'];?>" class="btn btn-sm btn-danger">Hapus</a>
                      <a href="index.php?page=edit-data-Admin&& id_admin=<?php echo $mhs['id_admin'];?>" class="btn btn-sm btn-success">Edit</a>
